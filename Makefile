...
PARFU_HEADER_FILES := parfu_primary.h tarentry.hh parfu_main.hh parfu_file_system_classes.hh parfu_rank_move_data.hh
...
PARFU_TEST_OBJECT_FILES := parfu_2021_legacy.o parfu_file_system_classes.o tarentry.o parfu_rank_move_data.o
